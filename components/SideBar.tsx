    ...
    return (
        <aside className="w-64 h-full bg-gray-100 p-6 border-r">
            <button
                ...
                className="w-full text-left rounded-lg border border-gray-300 bg-white px-4 py-2 text-gray-800 font-medium hover:border-blue-500 hover:bg-blue-50 hover:text-blue-600 transition mb-6"
            >
                📋 All Tasks
            </button>
